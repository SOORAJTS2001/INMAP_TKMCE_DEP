...
important_points = {"open_auditorium": (75, 35), "open_gymnasium": (72, 34), "open_tenniscourt": (69, 34), "open_volleycourt": (70, 47), "apj_park": (77, 51), "parking_front": (71, 55), "squash_court": (63, 51), "parking_back": (58, 74), "badminton_court": (62, 71), "basketball_court": (62, 77), "backgate": (53, 80), "library": (52, 70), "canteen": (
    56, 99), "stores": (51, 91), "workshop_block": (50, 91), "college_ground": (47, 100), "prayer_hall": (55, 92), "auditorium": (66, 93), "arch_block": (56, 113), "ladies_washroom": (63, 121), "gents_washroom": (66, 125), "coffee_corner": (74, 130), "mech_block": (72, 133), "chem_block": (72, 153), "annex_hostel": (73, 159), "kilivathil": (77, 152)}
...
def index(request):
    ...
    if request.method == "GET":
        ...
        now = time.time()
        return render(request, 'inmapapp/result.html', {"image": "inmapapp/static/inmapapp/modtkm_map.jpg", "time": now-then, "update": True})
        # print(From_x,From_y,To_x,To_y)
